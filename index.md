...
#> [1] "GOMAXPROCS=1 /usr/lib/go-1.22/bin/go 'build' '-mod=vendor' '-o' '/tmp/RtmpP6IOdC/file1a6da43504bcb8' '/tmp/RtmpP6IOdC/file1a6da41152510d.go'"
#> [1] "/tmp/RtmpP6IOdC/file1a6da43504bcb8"
```
...
tmp_bin <- tempfile()
mangoro_go_build(tmp_go, tmp_bin)
#> [1] "GOMAXPROCS=1 /usr/lib/go-1.22/bin/go 'build' '-mod=vendor' '-o' '/tmp/RtmpP6IOdC/file1a6da42d8a82eb' '/tmp/RtmpP6IOdC/file1a6da476357281.go'"
#> [1] "/tmp/RtmpP6IOdC/file1a6da42d8a82eb"
...
#> [1] "GOMAXPROCS=1 /usr/lib/go-1.22/bin/go 'build' '-mod=vendor' '-o' '/tmp/RtmpP6IOdC/file1a6da46d058d10' '/usr/local/lib/R/site-library/mangoro/go/cmd/rpc-example/main.go'"
#> [1] "/tmp/RtmpP6IOdC/file1a6da46d058d10"
...
#> [1] "GOMAXPROCS=4 /usr/lib/go-1.22/bin/go 'build' '-mod=vendor' '-o' '/tmp/RtmpP6IOdC/file1a6da42cd58c38' '/usr/local/lib/R/site-library/mangoro/go/cmd/http-server/main.go'"
#> [1] "/tmp/RtmpP6IOdC/file1a6da42cd58c38"
...
#> [2] "HTTP server controller listening on ipc:///tmp/RtmpP6IOdC/mangoro-echo1a6da431f6a1c6.ipc"
```
...
#> 1     ok HTTP server stopped
http_ctl_proc$read_output_lines()
#> [1] "[mangoro server] 2025/11/16 04:21:01 Starting HTTP server on 127.0.0.1:8080 serving /root/mangoro at /" 
#> [2] "[mangoro server] 2025/11/16 04:21:03 GET / 127.0.0.1:57012 72.601µs"                                    
#> [3] "[mangoro server] 2025/11/16 04:21:03 HTTP server stopped"                                               
#> [4] "[mangoro server] 2025/11/16 04:21:06 Starting HTTPS server on 127.0.0.1:8443 serving /root/mangoro at /"
#> [5] "[mangoro server] 2025/11/16 04:21:08 GET /.Rbuildignore 127.0.0.1:56048 2.452837ms"                     
#> [6] "[mangoro server] 2025/11/16 04:21:08 HTTP server stopped"
close(sock)
http_ctl_proc$kill()
#> [1] TRUE
```
