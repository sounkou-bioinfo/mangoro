...
The `rgoipc` package provides the interfaces for type-safe function registration with Arrow schema validation. See [inst/go/pkg/rgoipc](inst/go/pkg/rgoipc) for the Go package and [inst/go/cmd/rpc-example](inst/go/cmd/rpc-example) for a complete server example.
