...
The package includes `rgoipc`, a Go package for building RPC servers with function registration. Functons are registered in the go main application and called by R.
